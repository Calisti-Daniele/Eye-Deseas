...
selected_data_normalized = normalizza_feature_numeriche(selected_data,"scaler/scaler_trex_not_augmented_neural.pkl")
feature_names = selected_data.columns.tolist()  # Lista delle colonne originali

print(feature_names)
joblib.dump(feature_names, "scaler/feature_names_trex_not_augmented_neural.pkl")

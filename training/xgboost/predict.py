...
model_path = "../../models/best_xgboost_model_augmented.pkl"
best_model = joblib.load(model_path)
print(f"Modello caricato da: {model_path}")

# Caricamento dello scaler
scaler_path = "../../feature_engineering/regressione/scaler/scaler_trex_augmented.pkl"  # Percorso dello scaler usato per la normalizzazione
scaler = joblib.load(scaler_path)
print(f"Scaler caricato da: {scaler_path} con num di feature: {scaler.n_features_in_}")

# Caricamento dei dati non visti
new_data_path = "feature_selection/train_dataset_trex_augmented_for_prediction.csv"  # Percorso corretto
...
feature_names = joblib.load("../../feature_engineering/regressione/scaler/feature_names_trex_augmented.pkl")  # Percorso con i nomi delle feature originali
...
output_path = "feature_selection/previsioni_dati_trex_augemented_non_visti.csv"
